...
def detectHand(img, hog, depth):
    ...
    # 検出
    hands, w = hog.detectMultiScale(gray_img, hitThreshold=0, winStride=(16, 16), padding=(4, 4), scale=1.05, finalThreshold=5)
...
def main():
    ...
    try:
        while True:
            ...
            #color_frame = cv2.resize(color_frame, None, fx=0.5, fy=0.5)
            ...
            detectHandInImage(removed, cascade, depth)
